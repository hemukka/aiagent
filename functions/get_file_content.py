...
schema_get_file_content = types.FunctionDeclaration(
        ...
        description=f"Reads and returns the first {MAX_CHARS} characters of the content from the specified file within the working directory.",
        parameters=types.Schema(
            type=types.Type.OBJECT,
            properties={
                "file_path": types.Schema(
                    type=types.Type.STRING,
                    description="The path to the file to read contents from, relative to the working directory.",
                ),
            },
            required=["file_path"],
        ),
